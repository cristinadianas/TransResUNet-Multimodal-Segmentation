...
from early_fusion.resnet import resnet50
import numpy as np
import cv2
...
class TResUnet(nn.Module):
    def __init__(self, in_channels=3):
        ...
        """ ResNet50 """
        backbone = resnet50(pretrained=False, in_channels=in_channels)
        ...
        """ Bridge blocks """
        self.b1 = Bottleneck(1024, 256, num_layers=2)
        ...
        self.d4 = DecoderBlock([64, in_channels], 32)
